...
func newGood(db *gorm.DB, opts ...gen.DOOption) good {
	...
	_good.Deal = field.NewInt32(tableName, "deal")
	_good.Description = field.NewString(tableName, "description")
	_good.Shop = field.NewString(tableName, "shop")
	_good.Location = field.NewString(tableName, "location")
	_good.Postfree = field.NewInt32(tableName, "postfree")
	_good.Category = field.NewString(tableName, "category")
...
type good struct {
	...
	Shop        field.String  // 店铺
	Location    field.String  // 地址
	Postfree    field.Int32   // 是否包邮
...
func (g *good) updateTableName(table string) *good {
	...
	g.Deal = field.NewInt32(table, "deal")
	g.Description = field.NewString(table, "description")
	g.Shop = field.NewString(table, "shop")
	g.Location = field.NewString(table, "location")
	g.Postfree = field.NewInt32(table, "postfree")
	g.Category = field.NewString(table, "category")
...
func (g *good) fillFieldMap() {
	...
	g.fieldMap["deal"] = g.Deal
	g.fieldMap["description"] = g.Description
	g.fieldMap["shop"] = g.Shop
	g.fieldMap["location"] = g.Location
	g.fieldMap["postfree"] = g.Postfree
	g.fieldMap["category"] = g.Category
}
