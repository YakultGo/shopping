...
func newInventory(db *gorm.DB, opts ...gen.DOOption) inventory {
	...
	_inventory.GoodID = field.NewInt64(tableName, "good_id")
	_inventory.Stock = field.NewInt32(tableName, "stock")
...
func (i *inventory) updateTableName(table string) *inventory {
	...
	i.GoodID = field.NewInt64(table, "good_id")
	i.Stock = field.NewInt32(table, "stock")
...
func (i inventory) Columns(cols ...field.Expr) gen.Columns { return i.inventoryDo.Columns(cols...) }
